<div align="center">
  ...
  <p>
    <!-- VERSION -->
    <img src="https://img.shields.io/badge/version-3.4.0-FF9800" alt="Versa AGi version 3.4.0">
    <!-- /VERSION -->
  </p>
  <table align="center" width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td align="center"><img src="https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black" alt="Linux"></td>
      <td align="center"><img src="https://img.shields.io/badge/Ubuntu_24.04-E95420?style=flat-square&logo=ubuntu&logoColor=white" alt="Ubuntu 24.04"></td>
      <td align="center"><img src="https://img.shields.io/badge/Microsoft-00A4EF?style=flat-square&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%2BPHBhdGggZmlsbD0id2hpdGUiIGQ9Ik0xIDFoMTB2MTBIMXptMTIgMGgxMHYxMEgxM3pNMSAxM2gxMHYxMEgxem0xMiAwaDEwdjEwSDEzeiIvPjwvc3ZnPg%3D%3D" alt="Microsoft"></td>
      <td align="center"><img src="https://img.shields.io/badge/Windows-0078D6?style=flat-square&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%2BPHBhdGggZmlsbD0id2hpdGUiIGQ9Ik0wIDMuNDUgOS43NSAyLjF2OS40NUgwbTEwLjk1LTkuNkwyNCAwdjExLjRIMTAuOTVNMCAxMi42aDkuNzV2OS40NUwwIDIwLjdNMTAuOTUgMTIuNkgyNFYyNGwtMTIuOS0xLjgiLz48L3N2Zz4%3D" alt="Windows"></td>
      <td align="center"><img src="https://img.shields.io/badge/Apple-000000?style=flat-square&logo=apple&logoColor=white" alt="Apple"></td>
      <td align="center"><img src="https://img.shields.io/badge/macOS-000000?style=flat-square&logo=macos&logoColor=white" alt="macOS"></td>
    </tr>
  </table>
  <table align="center" width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      ...
      <td align="center"><img src="https://img.shields.io/badge/Gemini-8E75B2?style=flat-square&logo=googlegemini&logoColor=white" alt="Google Gemini"></td>
      <td align="center"><img src="https://img.shields.io/badge/Vertex-4285F4?style=flat-square&logo=googlecloud&logoColor=white" alt="Google Vertex AI"></td>
      <td align="center"><img src="https://img.shields.io/badge/OpenAI-191919?style=flat-square&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyMCAyMCI%%2BPC9zdmc%2B" alt="OpenAI"></td>
      ...
      <td align="center"><img src="https://img.shields.io/badge/SpaceX_AI-000000?style=flat-square&logo=spacex&logoColor=white" alt="SpaceX AI"></td>
      <td align="center"><img src="https://img.shields.io/badge/Grok-000000?style=flat-square&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCA0NjYuMDQgNTE2LjkzIiBmaWxsPSJ3aGl0ZSI%%2BPHBvbHlnb24gcG9pbnRzPSIzODAuNzggNTE2LjkyIDQ2Ni4wNCA1MTYuOTIgNDY2LjA0IDM3LjE2IDM4MC43OCAxNTguOTIgMzgwLjc4IDUxNi45MiIvPjwvc3ZnPg%3D%3D" alt="Grok"></td>
      <td align="center"><img src="https://img.shields.io/badge/OpenRouter-6566F1?style=flat-square&logo=openrouter&logoColor=white" alt="OpenRouter"></td>
      <td align="center"><img src="https://img.shields.io/badge/Hugging_Face-FFD21E?style=flat-square&logo=huggingface&logoColor=black" alt="Hugging Face"></td>
    </tr>
  </table>
  <table align="center" width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      ...
      <td align="center"><img src="https://img.shields.io/badge/Ollama-111111?style=flat-square&logo=ollama&logoColor=white" alt="Ollama"></td>
      <td align="center"><img src="https://img.shields.io/badge/Intel-0071C5?style=flat-square&logo=intel&logoColor=white" alt="Intel"></td>
      <td align="center"><img src="https://img.shields.io/badge/NVIDIA-76B900?style=flat-square&logo=nvidia&logoColor=white" alt="NVIDIA"></td>
      <td align="center"><img src="https://img.shields.io/badge/AMD-ED1C24?style=flat-square&logo=amd&logoColor=white" alt="AMD"></td>
    </tr>
  </table>
</div>
...
Local AI is three different runtimes — see [Local AI support](docs/local-ai-support.md). WSL server extra steps: [install-wsl-server.md](docs/install-wsl-server.md).
...
| [Local AI support](docs/local-ai-support.md) | Ollama vs SYCL vs sd-cli — what is supported |
...
<p align="center">
  ...
  <small>© Copyright 2026. <strong>VersaVoice AI™</strong>, <strong>Versa AGi™</strong> - VersaVoice AI LLC. All Rights Reserved.</small>
</p>
