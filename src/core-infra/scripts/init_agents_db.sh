...
CREATE TABLE IF NOT EXISTS agents (
  ...
  runaway_threshold INTEGER DEFAULT 2500,
  ...
  max_session_turns     INTEGER DEFAULT 400,
  tool_output_token_budget INTEGER DEFAULT 5000,
  triage_model      TEXT,
  ...
  resume_max_messages INTEGER DEFAULT 25,
