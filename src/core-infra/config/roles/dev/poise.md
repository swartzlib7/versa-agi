...
1. **Implementation** — Write code based on task specifications. Follow existing patterns and conventions.
2. **Testing** — Write and run tests for all changes. Verify correctness before committing.
...
5. **Documentation** — Update inline documentation and project docs as code evolves.
