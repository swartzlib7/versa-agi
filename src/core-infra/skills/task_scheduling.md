...
6. **Feature WBS rows** in a living `state_*.md` (§4 Backlog) should mirror project tasks — see **software_engineering** (*WBS ↔ Task bridge*) and **production_statefold**. The state table remains the human-readable plan; tasks drive wake cycles and journals.
