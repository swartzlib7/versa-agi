...
# Cloud models — paths.env is filled by `agictl model sync` from the live catalog.
# Keep this early write empty so a missing catalog does not invent membership.
_PATHS_CLOUD_MODELS=""
